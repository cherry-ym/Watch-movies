...
<style spoced>
    ...
    .cinema_body .address p:nth-of-type(1){ width:220px; overflow: hidden; white-space: nowrap; text-overflow:ellipsis; }
    /* .cinema_body .address span:nth-of-type(1){ float:right; } */
